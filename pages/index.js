    ...
    return (
        <div className="xl:w-8/12 md:w-9/12 sm:w-10/12 m-0 mr-auto ml-auto">
            <div>
                ...
                <div className="w-full m-0 mr-auto ml-auto mt-9">
                    <Image
                        width={800}
                        height={600}
                        src={qandliDiabet}
                ...
                <p className="xl:w-8/12 -sm:pl-3 -sm:pr-3 m-0 mr-auto ml-auto mt-5">
                    🔼 Қон босимининг ошиши бугунги кунда юрак-томир тизимининг
                    энг кенг тарқалган касалликларидан бири бўлиб, кутилмаган
                    вазиятларда намоён бўлиши мумкин. Хўш, нима деб ўйлайсиз,
                    сизнинг қон босимингиз меъёридами? Келинг, буни 5 дақиқа
                    ичида синаб кўрамиз.
                </p>
            </div>

            <div className="w-full -sm:pl-3 -sm:pr-3 mr-auto ml-auto mt-5">
