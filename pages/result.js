...
const Result = () => {
    ...
    return (
        <>
            ...
            <Navbar />
            <div className="xl:w-7/12 md:w-9/12 sm:w-10/12 m-0 mr-auto ml-auto mt-28">
                <h2 className="font-medium text-xl mr-auto ml-auto -sm:pl-3 -sm:pr-3">
                    {analyzeResult?.title}
                </h2>
                <ol className="list-disc ml-5 mt-6 -sm:pl-3 -sm:pr-3">
                ...
                <div className="img mt-6">
                    <Image
                        ...
                        layout="responsive"
                    />
                    <h2 className="mt-4 text-xl font-medium -sm:pl-3 -sm:pr-3">{`Сабаби ''Alhadaya'' қора седана капсулалари таркибидаги`}</h2>
                </div>

                <ol className="list-disc ml-5 mt-6 -sm:pl-3 -sm:pr-3">
                    <li>
                        Магний ва натрий юрак, қон-томир ишини тартиблаштиришда;{" "}
                    </li>
                    <li>Қонни суюлтиришда;</li>
                    <li>Асабларни тинчлантиришда; </li>
                    <li>
                        Қон босимини ва холестерин миқдорини меъёрлаштиришда
                        самарали ёрдам беради.
                    </li>
                </ol>

                <p className="mt-4 -sm:pl-3 -sm:pr-3">
                ...
                <h2 className="font-medium text-md mr-auto ml-auto mt-6 -sm:pl-3 -sm:pr-3">
                    Ушбу маҳсулотлар ҳақида мутахассисимиздан БЕПУЛ консультация
                    олиш, шунингдек, махсус чегирма ва совғалар қўлга киритишни
                    истайсизми? Бунинг учун ўз рақамингизни ёзиб қолдиринг, биз
                    эса сиз билан тез орада алоқага чиқамиз!
                </h2>
